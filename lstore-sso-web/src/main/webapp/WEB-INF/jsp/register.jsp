...
<!-- header -->
<div class="header">
    <a href="http://www.lstore.chenjianlink.cn"><img src="/images/logo.png" border="0"/><span>欢迎注册</span></a>
</div>
...
<div class="reg_main reg_border regTab" id="perDiv">
    <ul class="individualUserBg">
        <form id="regForm_mod" name="regForm_mod" method="post">
			...
			<span class="regM" style="margin-left:29px">
				...
				<a href="https://passport.lstore.chenjianlink.cn/xy.html" target="_blank"
                   class="checkTitle">我已阅读并同意<font style="font-size:12px;">《局外人商城用户注册协议》</font></a>
			</span>
    ...
    <div class="ui-reg-tip"><a href="http://help.lstore.chenjianlink.cn/140/6788.html" target="_blank">了解更多>></a></div>
</div>
...
<div class="footer">
			<span>
				<a href="http://www.lstore.chenjianlink.cn/www/379/5109.html" rel="nofollow"
                   class="footerlink1">关于我们</a> |
				<a href="http://www.lstore.chenjianlink.cn/www/380/5116.html" rel="nofollow"
                   class="footerlink1">联系我们</a> |
				<a href="http://www.lstore.chenjianlink.cn/www/381/5117.html" rel="nofollow"
                   class="footerlink1">招聘人才</a> |
				<a href="http://www.lstore.chenjianlink.cn/www/330/2705.html" rel="nofollow"
                   class="footerlink1">友情链接</a> |
				<a href="http://supplier.lstore.chenjianlink.cn/supplierApply" rel="nofollow"
    ...
    <p>
        ...
        Copyright© 局外人商城 lstore.chenjianlink.cn 版权所有<br/>
    </p>
</div>
<!-- /footer -->
